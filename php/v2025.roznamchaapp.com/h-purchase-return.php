<?php
  ...
  $meta['info']['title']='Purchase Return History';
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                    <h3>Customize Purchase Return History</h3>
                              ...
                              <div class="table-responsive m-t-40" id="no-more-tables">
                                ...
                                <tbody>
                                  ...
                                  if(isset($_GET['from_date']) && $_GET['from_date']!='')
                                  {
                                    ...
                                    $select_qry="select * from `purchase_invoices_returns` where `owner_mobile`='$_SESSION[sess_bp_username]' $where order by `id` desc";
                                   ...
                                   ?>
                                    <tr>
                                      ...
                                      <td><a href="h-purchase-return-invoice.php?id=<?=$row['id']?>" class="btn btn-sm btn-warning">View Invoice</a></td>
                                    </tr>
                                    <?php
                                    }
                                   ?>
