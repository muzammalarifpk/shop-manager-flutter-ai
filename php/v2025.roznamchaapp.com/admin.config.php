<?php
  ...
  $meta['info']['title']='Admin';
  $meta['info']['des']='admin page description will go here.';
  $meta['module']=array('admin');
      ...
      $('.dangerbtn').click(function(e){
          ...
          swal({
              ...
              if (isConfirm) {
                ...
                $.get( 'admin-delete.php?reqid='+reqid, function( data ) {
...
";
  ...
  $all_fields['username']=array('name'=>'Username','is_req'=>1,'type'=>'text');
  ...
  $table_heads=array('username','fname','phone','privs','status');
