<?php
  $meta=array();
  $meta['info']['title']='Admn Login';
  $meta['info']['des']='Admin Login';
  require_once("includes/dbc.php");
  if(isset($_SESSION['sess_bp_admin_id']) && isset($_SESSION['sess_bp_admin']) && isset($_SESSION['sess_bp_name_admin']))
  {
                ...
                <div class="card-body loginform">
                    <form class="form-horizontal form-material" id="loginform" action="">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" id="username" required="required" placeholder="Username" autofocus> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" type="password" id="password" required="required" placeholder="Password"> </div>
                        </div>
                        ...
                        <div class="form-group hide m-b-0">
