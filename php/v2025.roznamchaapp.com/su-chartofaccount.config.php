...
$meta=array();
$meta['info']['title']='Chart of Account';
$meta['info']['des']='Manage Banks, Equity, Expense and other Accounts';
$meta['module']=array('chartofaccount','su-chartofaccount');
...
$all_fields['account_head']=array('name'=>'Account Name','is_req'=>1,'type'=>'text');
$all_fields['account_type']=array('name'=>'Account Type','is_req'=>1,'type'=>'dropdown','attr'=>array($list_account_types_new));
$all_fields['balance_type']=array('name'=>'Balance Status','is_req'=>1,'type'=>'dropdown','attr'=>array($list_balance_drcr));
$all_fields['balance']=array('name'=>'Current Balance','is_req'=>1,'type'=>'number');

$form_layout['basic'][]=array('account_head'=>'col-md-6','account_type'=>'col-md-6');
$form_layout['basic'][]=array('balance'=>'col-md-6','balance_type'=>'col-md-6');
$form_layout['basic'][]=array('status'=>'col-md-6');
$form_layout['basic'][]=array('notes'=>'col-md-12');

$table_heads=array('account_head','account_type','balance','balance_type','status');
