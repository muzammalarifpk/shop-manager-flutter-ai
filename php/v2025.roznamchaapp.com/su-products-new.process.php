...
if($err=='<ol><ol/>')
{
  try {
    ...
    if($reqid=='')
    {
      ...
      $query.=" `product_description`=:product_description,  `title`=:title,  `youtube_link`=:youtube_link,  `platforms`=:platforms,  `secondary_unit_count`=:secondary_unit_count,  `secondary_units`=:secondary_units,   `lend_inventory`=:lend_inventory,  `last_updated`=:last_updated, `owner_mobile`=:owner_mobile, `added_by`=:added_by, `timestamp`=:timestamp ";
    ...
    if($reqid=='')
    {
      ...
      $stmt->bindParam('lend_inventory', $lend_inventory);
    ...
    $response['product_name']=$postinfo['name'];
    $response['product_unit']=$postinfo['measuring_unit'];
    $response['product_sale_price']=$postinfo['sale_price'];
    $response['product_available']=$postinfo['available_stock'];
    $response['product_purchase_cost']=$postinfo['purchase_cost'];
    $response['product_tags']=$postinfo['tags'];
    $response['product_barcode']=$postinfo['barcode'];
    $response['product_']=$postinfo['name'];
