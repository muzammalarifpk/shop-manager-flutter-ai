$(function() {
    ...
    $(document).on('click','.expand_btn',function(e)
    {
      e.preventDefault();

      $('.expand_rows i.mdi-menu-down').addClass('mdi-menu-right');
      $('.expand_rows i.mdi-menu-down').removeClass('mdi-menu-down');

      $('.expand_rows').removeClass('expand_rows');
      $(this).closest('tr').addClass('expand_rows');
      $('.expand_rows i').removeClass('mdi-menu-right');
      $('.expand_rows i').addClass('mdi-menu-down');


    });

    $(document).on('click','i.mdi-menu-down',function(e){
      e.preventDefault();
      $('.expand_rows i.mdi-menu-down').addClass('mdi-menu-right');
      $('.expand_rows i.mdi-menu-down').removeClass('mdi-menu-down');
