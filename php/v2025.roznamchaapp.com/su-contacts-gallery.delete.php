...
$select_images_qry = "select * from `gallery` where `owner_mobile`='$_SESSION[sess_bp_username]' and `type`='contacts' and `id`='$_GET[file_id]' and `status`='Published' order by `id` asc";
$images_array=array();
