...
$select_qry="SELECT * FROM `locations` WHERE owner_mobile = '$_SESSION[sess_bp_username]' and `id`='$_GET[reqid]' ";
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <div class="form-check">
                                              <label class="custom-control custom-radio hide">
                                                  <input id="type1" name="type" type="radio" class="custom-control-input" value="shop">
                                                  <span class="custom-control-indicator"></span>
                                                  <span class="custom-control-description">Shop</span>
                                              </label>
                                              <label class="custom-control custom-radio">
                                                  <input id="type2" name="type" type="radio" class="custom-control-input" value="warehouse" checked="" >
                                                  <span class="custom-control-indicator"></span>
