        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Purchase Return Invoice</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="t-sale-returns.php">New Purchase Return</a></li>
                    </ol>
                </div>
                <div class="hide">
                    ...
                    <div class="col-12">
                        <div class="card" style="background:#fff;">
                            <div class="card-body">
                              ...
                              <?php
                                $invoice_qry="select * from `purchase_invoices_returns` where `id`='$_GET[id]' and `owner_mobile`='$_SESSION[sess_bp_username]'";
