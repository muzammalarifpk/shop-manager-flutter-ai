                        ...
                        <div class="card">
                            <div class="card-body">
                              ...
                              <div class="table-responsive m-t-40" id="no-more-tables">
                                ...
                                <tbody>
                                  <?php
                                    $select_qry="select * from `expense` where `owner_mobile`='$_SESSION[sess_bp_username]' order by `id` desc";
                                   ...
                                   ?>
                                    <tr>
                                      ...
                                      <td class="d-none"><a href="h-expense-invoice.php?id=<?=$row['id']?>" class="btn btn-sm btn-warning">View Invoice</a></td>
                                    </tr>
                                    <?php
                                    }
                                   ?>
