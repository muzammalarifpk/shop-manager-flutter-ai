...
$select_images_qry = "select * from `gallery` where `owner_mobile`='$_SESSION[sess_bp_username]' and `type`='products' and `ref_id`='$_GET[product_id]' and `status`='Published' order by `id` asc";
$images_array=array();
