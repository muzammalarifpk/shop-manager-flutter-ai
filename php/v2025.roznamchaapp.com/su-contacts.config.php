...
$all_fields['number']=array('name'=>'International Format','is_req'=>0,'type'=>'text','attr'=>array('disabled'),'is_unique'=>true);
$all_fields['type']=array('name'=>'Type','is_req'=>1,'type'=>'dropdown','attr'=>array($list_relationship_types));
$all_fields['balance_status']=array('name'=>'Balance Status','is_req'=>1,'type'=>'dropdown','attr'=>array($list_balance_types));
$all_fields['balance']=array('name'=>'Current Balance','is_req'=>0,'type'=>'number');

$form_layout['basic'][]=array('name'=>'col-md-6','type'=>'col-md-3','status'=>'col-md-3');
...
$form_layout['basic'][]=array('tags'=>'col-md-6','duedate'=>'col-md-6');
$form_layout['basic'][]=array('email'=>'col-md-6','city'=>'col-md-6');
$form_layout['basic'][]=array('notes'=>'col-md-12');

$table_heads=array('name','type','number','balance','balance_status','status','email');
