...
$meta=array();
$meta['info']['title']='Record New Expense';
$meta['info']['des']='Record New Expense invoices..';
$meta['module']=array('t-expense','t-expense');
...
$meta['check']['permission']=true;
  ...
  $meta['footer']['script']="    <script>
      ...
      function delete_expense(usernumber){
        reqid=usernumber;
        swal({
            title: 'Are you sure?',
            ...
            if (isConfirm) {
              ...
              $.get( 't-expense-delete.php?reqid='+reqid, function( data ) {
