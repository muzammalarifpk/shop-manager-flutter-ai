...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                $select_invoice_data_qry="select * from `sale_invoices` where `owner_mobile`='$_SESSION[sess_bp_username]' and (`status`='published' || `status`='Published') and id='$_GET[id]' ";
...
//                                              $balance_status=gnrm($db,'ledger',$contact_where,'balance_type');
        ...
        <script type="text/javascript">
          ...
          $('#location_id').val('<?=$row_invoice['location_id']?>');
