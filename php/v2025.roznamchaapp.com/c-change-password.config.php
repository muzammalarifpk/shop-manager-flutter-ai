<?php
$meta=array();
$meta['module']=array('users','c-change-password');
$meta['check']['admin']=false;
$meta['check']['permission']=false;

require_once('includes/dbc.php');
  $meta['info']['title']=$string['c']['title'];
  $meta['info']['des']=$string['c']['des'];
              ...
              if (isConfirm) {
                ...
                $.get( delurl, function( data ) {
                  // the contents is now in the variable data
                    ...
                    {
                        swal({
                           title: '".$string['g']['deleted']."',
                           text: '".$string['g']['deleted_msg']."',
                           timer: 2000,
                           type: 'success',
                       ...
                       swal({
                          title: '".$string['g']['error']."',
                          text: '".$string['g']['error_delete_msg']."',
                          timer: 3000,
                          type: 'warning',
                          showConfirmButton: false
                      });
                  ...
                  swal({
                     title: '".$string['g']['delete_cancel']."',
                     text: '".$string['g']['delete_cancel_msg']."',
                     timer: 2000,
                     type: 'warning',
                     showConfirmButton: false
                 });
