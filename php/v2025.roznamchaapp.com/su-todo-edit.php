...
$select_qry="SELECT * FROM `todo` WHERE owner_mobile = '$_SESSION[sess_bp_username]' and `id`='$_GET[reqid]' ";
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required="" id="job" name="job" aria-required="true" value="<?=$row[0]['job']?>">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="date"> Date: <span class="text-danger">*</span></label>
                                    <input type="date" class="form-control" required="" id="date" name="date" aria-required="true"  value="<?=$row[0]['date']?>">
                                  </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="customer" id="customer">
                                      ...
                                      foreach ($db->query($contacts_query) as $rowc)
                                      {
...
//                                              $balance_status=gnrm($db,'ledger',$contact_where,'balance_type');
                                        ...
                                        $contacts_data[$rowc['number']]=array('balance'=>$rowc['balance'],'status'=>$rowc['balance_status']);
                                       ?>
                                      <option value="<?=$rowc['number']?>"><?=$rowc['name']?> (<?=$rowc['number']?>)</option>
                                      <?php
                                        }
...
//                                              $balance_status=gnrm($db,'ledger',$contact_where,'balance_type');
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required="" id="item_name" name="item_name" aria-required="true" value="<?=$row[0]['item_name']?>">
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required="" id="uom" name="uom" aria-required="true"  value="<?=$row[0]['uom']?>">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="qty"> qty: <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" required="" id="qty" name="qty" aria-required="true" value="<?=$row[0]['qty']?>">
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required="" id="brand" name="brand" aria-required="true" value="<?=$row[0]['brand']?>">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="priority"> priority: <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" required="" id="priority" name="priority" aria-required="true"  value="<?=$row[0]['priority']?>">
                                  </div>
                                </div>
                              </div>
