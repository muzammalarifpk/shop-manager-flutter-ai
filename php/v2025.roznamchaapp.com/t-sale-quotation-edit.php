<?php
  ...
  $meta['info']['title']='Edit Qoutation';
...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                $select_invoice_data_qry="select * from `sale_quotations` where `owner_mobile`='$_SESSION[sess_bp_username]' and (`status`='published' || `status`='Published') and id='$_GET[id]' ";
                                   ...
                                   <div id="print_size" class="print_size_<?=$default_size_template?>">
                                      ...
                                      <div class="print_row">
                                        <table class="print_table" id="print_products">
                                          <thead class="print_inverse">
                                            <tr>
                                              <th>#</th>
                                              <th>Products <span class="ur_lang">مصنوعات</span></th>
                                              ...
                                              <th>Unit Measure <span class="ur_lang">پیمائش</span></th>
                                      ...
                                      <div class="print_row">
                                        ...
                                        <div class="print_half">
                                          ...
                                          <h3>Payment Method: <span class="ur_lang">ادائیگی کا طریقہ</span><span class="print_pull_right" id="print_payment_method">N/A</span></h3>
                                          <h3>Amount Received: <span class="ur_lang">رقم موصول ہوئی</span><span class="print_pull_right" id="print_amount_recieived">0.00</span></h3>
                                          <h3>Remaining Amount: <span class="ur_lang">بقایا رقم</span><span class="print_pull_right" id="print_invoice_balance">0.00</span></h3>
                                          <hr>
                                          <h3>Old Balance: <span class="ur_lang">پرانی رقم</span><span class="print_pull_right" id="print_old_balance">0.00</span></h3>
                                          <h3>Total Balance: <span class="ur_lang">نئی باقی رقم</span><span class="print_pull_right" id="print_total_balance">0.00</span></h3>
                                        </div>
                                        <div class="print_clearfix"></div>
                                      </div>
                                      <div class="print_row">
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          ...
                                          <select class="form-control select2" name="contact_name" id="contact_name">
                                            ...
                                            <?php
                                            $contacts_query="select * from `contacts` where `owner_mobile`='$_SESSION[sess_bp_username]' and `type`='customer'";
...
//                                              $balance_status=gnrm($db,'ledger',$contact_where,'balance_type');
                                      ...
                                      <div class="row">
                                        <div class="col-md-12 block12">
                                            ...
                                            <table class="table table-bordered full-color-table hover-table" id="services_in_cart">
                                              <thead>
                                                <tr>
                                                  <th>Service Name</th>
                                                  <th>Unit Price</th>
                                      ...
                                      <div class="row">
                                        <div class="col-sm-12">
                                          ...
                                          <a href="#" id="submitbtn" class=" btn btn-success pull-right">Generate Invoice</a></div>
                                      </div>
