                                  ...
                                  <div class="row">
                                    <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="category" name="category" aria-required="true">
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required="" id="sale_price" name="sale_price" aria-required="true">
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="wholesale_price" name="wholesale_price" aria-required="true">
                                      </div>
                                    </div>
                                  </div>
