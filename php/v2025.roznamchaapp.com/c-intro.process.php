...
{
  $update_qry="update `users` set  `currency`=:currency , `address`=:address , `city`=:city , `region_name`=:state , `country_name`=:country_name ,  `negative`=:negative ,  `last_updated`=:last_updated , `gst`=:gst , `tax`=:tax ,  `barcode`=:barcode , `variants`=:variants , `secondary_units`=:secondary_units , `salesman_commission`=:salesman_commission , `agent_commision`=:agent_commision , `vat`=:vat  where `number`=:number ";
