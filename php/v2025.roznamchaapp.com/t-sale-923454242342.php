...
?>
                              ...
                              <?php
                               ...
                               ?>
                                    ...
                                    <form class="form-horizontal" id="invoice_form" action="" method="post">
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                          <label for="custom_field">Supply Rate</label>
                                        </div>
                                        <div class="col-sm-6">
                                          <input type="number" class="form-control" name="custom_field" id="custom_field" value="0">
                                        </div>
                                      </div>
        ...
        <script type="text/javascript">
          ...
          var post_url = 't-sale-923454242342.process.php';
          var invoice_url = 'h-sale-invoice-923454242342.php?id=';
          var currency = '<?=$_SESSION['sess_bp_currency']?>';
        </script>
        <script type="text/javascript" src="js/invoice-923454242342.js"></script>
    <!-- Style switcher -->
    <!-- ============================================================== -->
</body>
</html>
