<?php
  ...
  $meta['info']['title']='Product Gallery';
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                              ...
                              <div class="row">
                                <div class="col-12">
                                  <div data-action="su-products-gallery.process.php?product_id=16357" class="dropzone">
                                  </div>
                                </div>
                              </div>
  ...
  <script type="text/javascript">
    ...
    <script>
        ...
        function load_images()
        {
          $('.preloader').show();
          var formdata = '';
          var urlpost = 'su-products-gallery.loadfiles.php?product_id=<?=$_GET['product_id']?>';
    ...
    */
      ...
      //            setTimeout(function(){ window.location.reload(); }, 3000);
        ...
        function delete_img(file_id)
        {
          $('.preloader').show();
          var formdata = '';
          var urlpost = 'su-products-gallery.delete.php?file_id='+file_id;
    ...
    $(function() {
        ...
        var myDropzone = new Dropzone(".dropzone", {
            url: "su-products-gallery.process.php?product_id=<?=$_GET['product_id']?>",
            paramName: "file",
            maxFilesize: 11,
            maxFiles: 10,
