...
-->
                                      ...
                                      <td data-title="Status"><?=$row['status']?>
                                        ...
                                        <!-- <a rel="<?=$row['number']?>" href="a-users.php" onclick='return reset_user("<?=$row['number']?>");' class="resetbtn text-warning" title="" data-toggle="tooltip" data-original-title="Reset"><i class="ti-reload"></i></a> -->
