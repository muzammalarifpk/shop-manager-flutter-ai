<?php
  ...
  try
  {
    ...
    $load_chat="select * from `chats` where (`owner_mobile`='$_SESSION[sess_bp_username]' and `to_contact`='$_POST[to_chat]' ) or (`to_contact`='$_SESSION[sess_bp_username]' and `owner_mobile`='$_POST[to_chat]' ) order by `id` asc";
    $chat_row='';
