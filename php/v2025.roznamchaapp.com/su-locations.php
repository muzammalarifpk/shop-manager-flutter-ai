<?php
  require_once("su-locations.config.php");
                        ...
                        <div class="card m-t-20">
                            <div class="card-body">
                              <div class="row">
                                ...
                                <?php
                                  if(isset($_GET['tag']))
                                  {
                                    ?>
                                    <div class="col-md-6">
                                        <h5>Tag: <a href="su-locations.php" class="btn btn-danger"><i class="fa fa-close"></i> <?=$_GET['tag']?></a></h5>
                                    </div>
                              ...
                              if(isset($_GET['tag']))
                              {
                                ...
                                $select_qry="select * from `locations` where `owner_mobile`='$_SESSION[sess_bp_username]' $all_status_where order by `name` asc";
...
<?php                                    foreach ($db->query($select_qry) as $row) {
                          ...
                          <br>
                          <p>
                            <a href="su-locations.php?show_all_status=yes" class="btn btn-sm pull-right btn-info">Show Deleted</a>
                            <a href="su-locations.php" class="btn btn-sm pull-right btn-inverse">Hide Deleted</a>
                          </p>
                          <?php
                        } ?>
  ...
  <script type="text/javascript">
    ...
    $(document).on('click','#editbtn',function(e){
      ...
      var urlpost = 'su-locations-edit.process.php';
    ...
    $(document).on('click','#submitBtn',function(e){
      ...
      $('.preloader').show();
      var form_data = $("#new_form").serialize();
      var urlpost='su-locations-new.process.php';
