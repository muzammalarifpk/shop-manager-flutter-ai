<?php
  ...
  $meta['info']['title']='New Sale Return';
  $meta['info']['des']='Return Sale Items ';
...
//                                              $balance_status=gnrm($db,'ledger',$contact_where,'balance_type');
 ...
 //                                              $balance_status=gnrm($db,'ledger',$contact_where,'balance_type');
        ...
        <script type="text/javascript">
          ...
          var this_module = 'sale-return';
          var post_url = 't-sale-returns.new.php';
          var invoice_url = 'h-sale-return-invoice.php?id=';
