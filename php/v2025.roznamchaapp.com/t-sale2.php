...
//                                              $balance_status=gnrm($db,'ledger',$contact_where,'balance_type');
                                      ...
                                      <div id="invoice_details" <?php if($entries_count<10){ echo 'class="hide"';} ?> >
                                        ...
                                        <div class="row">
                                          <div class="col-sm-12"><a href="#" id="resetbtn" class="btn btn-danger pull-left">Cancel</a><a href="#" id="reopen-last-print" class="btn-link pull-left hide">Reopen</a><a href="#" id="submitbtn" class="btn btn-success pull-right" >Save and Next</a></div>
                                        </div>
                                      </div>
        ...
        <script type="text/javascript">
          ...
          var post_url = 't-sale2.process.php';
          var pos_state = true;
