...
$update_qry = "update `expense_type` set `name`='$_POST[name]',`status`='$_POST[status]',`description`='$_POST[description]', `notes`='$_POST[notes]' where  `owner_mobile`='$_SESSION[sess_bp_username]' and `id`='$id'";
