...
$meta=array();
$meta['info']['title']='Employess Access';
$meta['info']['des']='Manage Employess access to POS';
$meta['module']=array('posaccess','su-posaccess');
...
$all_fields['name']=array('name'=>'Employee Name','is_req'=>1,'type'=>'text');
$all_fields['number']=array('name'=>'International Format','is_req'=>0,'type'=>'text','attr'=>array('disabled'));
$all_fields['privs']=array('name'=>'Privileges','is_req'=>1,'type'=>'tags');

$form_layout['basic'][]=array('name'=>'col-md-6','status'=>'col-md-6');
$form_layout['basic'][]=array('privs'=>'col-md-6');
$form_layout['basic'][]=array('notes'=>'col-md-12');

$table_heads=array('name','privs','status');
