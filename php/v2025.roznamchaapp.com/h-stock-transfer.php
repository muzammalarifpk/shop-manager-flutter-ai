<?php
  ...
  $meta['info']['title']='Stock Transfer History';
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                    <h3>Customize Stock Transfer History</h3>
                              ...
                              <div class="table-responsive m-t-40" id="no-more-tables">
                                ...
                                <tbody>
                                  ...
                                  if(isset($_GET['from_date']) && $_GET['from_date']!='')
                                  {
                                    ...
                                    $select_qry="select * from `stock_transfer` where `owner_mobile`='$_SESSION[sess_bp_username]' $where  order by `id` desc";
...
//                                    echo $select_qry;
                                   ...
                                   ?>
                                    <tr>
                                      <td data-title="ID: #" class="bolder num"><?=$row['id']?><br /><a href="h-sale-invoice.php?id=<?=$row['id']?>" class="btn btn-sm btn-warning view_invoice_btn" rel="<?=$row['id']?>" >View</a></td>
                  ...
                  <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h4 class="modal-title">Stock Transfer <span class="stock_transfer_id">N/A</span></h4>
                            ...
                            <div class="row  el-element-overlay">
                                ...
                                <div id="invoice_printable_area" style="width:100%; margin:10px;">
                                  ...
                                  <div class="invoice_body">
                                    ...
                                    <div class="print_row">
                                      <h1 class="print_center">Stock Transfer History</h1>
                                    </div>
                                    <div class="print_row">
                                      <div class="print_half">
                                        <h3>From Location: <span class="from_location">N/A</span></h3>
                                        <h3>To Location: <span class="to_location">N/A</span></h3>
                                      </div>
                                      <div class="print_half">
                                        <h2>&nbsp;</h2>
                                        <h3 class="">Transfer ID: <span class="stock_transfer_id print_pull_right">N/A</span></h3>
                                        <h3 class="">Date: <span class="print_transfer_date print_pull_right">N/A</span></h3>
                                      </div>
                                      <div class="print_clearfix"></div>
                                    </div>
                                    <div class="print_row">
    ...
    <script type="text/javascript">
      ...
      $(document).on('click','.view_invoice_btn',function(e){
        e.preventDefault();
        $('.preloader').show();
        var stock_transfer_id = $(this).attr('rel');
        //alert(stock_transfer_id);

        var formdata = {"invoiceid":stock_transfer_id};
        $.post( "h-stock-transfer.getdetails.php", formdata)
          .done(function( data ) {
            if(data!='error')
            {
...
//          alert('sending print.');
        ...
        $('.preloader').hide();
              ...
              $(document).on('click','.delete_btn',function(e)
              {
                ...
                $.post( "t-sale-delete.procesadfass.php", formdata)
                  .done(function( data ) {
                    if(isValidJSONString(data))
                    {
                      ...
                      if(response.code == 200){
                          ...
                          window.location.href='h-stock-transfer.php';
