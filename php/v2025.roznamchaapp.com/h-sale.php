                            ...
                            <div class="card-body">
                              ...
                              <div class="table-responsive m-t-40" id="no-more-tables">
                                <table class="nowrap table table-hover table-striped table-bordered">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td data-title="Sales Count" id="sales_count"></td>
                                ...
                                <tbody>
                                  ...
                                  if(isset($_GET['from_date']) && $_GET['from_date']!='')
                                  {
                                    ...
                                    $select_qry="select * from `sale_invoices` where `owner_mobile`='$_SESSION[sess_bp_username]' $where $all_status_where order by `id` desc";
