...
function check_access_level_radio(clas)
{
                        ...
                        <div class="card m-t-20">
                            <div class="card-body">
                              ...
                              if(isset($_GET['tag']))
                              {
                                ...
                                $select_qry="select * from `services` where `owner_mobile`='$_SESSION[sess_bp_username]' $all_status_where order by `name` asc";
                               ...
                               ?>
                              <div class="table-responsive m-t-3"  id="no-more-tables">
                                  ...
                                  $i=1;
                                   ...
                                   ?>
                                    <tr class="">
                                      ...
                                      <td data-title="Price: "><?=$row['sale_price']?></td>
  ...
  <script type="text/javascript">
    ...
    $(document).on('click','#editbtn',function(e){
      ...
      var urlpost = 'su-services-edit.process.php';
    ...
    $(document).on('click','#submitBtn',function(e){
      ...
      $('.preloader').show();
      var form_data = $("#new_form").serialize();
      var urlpost='su-services-new.process.php';
