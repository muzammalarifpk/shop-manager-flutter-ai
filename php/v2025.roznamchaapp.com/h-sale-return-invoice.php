        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Sale Return Invoice</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="t-sale-returns.php">New Sale Return</a></li>
                    </ol>
                </div>
                <div class="hide">
                    ...
                    <div class="col-12">
                        <div class="card" style="background:#fff;">
                            <div class="card-body">
                              ...
                              <?php
                                $invoice_qry="select * from `sale_invoices_returns` where `id`='$_GET[id]' and `owner_mobile`='$_SESSION[sess_bp_username]'";
                                ...
                                if ($res = $db->query($invoice_qry)) {
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-sm-6"><a href="t-sale-returns.php" id="new_sale" class="btn btn-warning d-print-none">New Sale Return</a></div>
                                        <div class="col-sm-6">
                                          <a href="sms:<?=$row['contact_number']?>?&body=<?=urlencode('Sale Invoice # '.$row['id'].' %0a%0aTotal Amount: '.$row['grand_total'].' %0aPaid:  '.$row['amount_paid'].' %0aRemaining Amount:  '.$row['remaining_amount'].' %0aUpdated Balance:  '.gnrm($db,'ledger',"`account_id`='c$row[contact_number]' and `owner_mobile`='$_SESSION[sess_bp_username]' order by `id` desc",'balance').'%0a%0aPowered by BasePlan.pk')?>" id="smsbtn" class="btn btn-primary pull-right d-print-none">Send SMS</a>
