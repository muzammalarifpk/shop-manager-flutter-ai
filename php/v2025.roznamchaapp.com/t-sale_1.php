...
.form-horizontal .row{ margin-top: 10px; margin-bottom: 10px;}
        ...
        <div class="page-wrapper">
            ...
            <!-- Container fluid  -->
            <!-- ============================================================== -->
            <div class="container-fluid_gone">
                <!-- ============================================================== -->
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="row el-element-overlay">
                                                ...
                                                <?php
                                                  $products_query="select * from `products` where `owner_mobile`='$_SESSION[sess_bp_username]' and `status`='Published'";
...
<?php
 ...
 ?>
                                    ...
                                    <form class="form-horizontal" id="invoice_form" action="" method="post">
                                      ...
                                      <div class="row">
                                        <div class="col-6">
                                          <lable for="contact_name">Customer</lable>
                                      ...
                                      <div class="row">
                                        <div class="col-12 block12 table_holder">
                                            <table class="table table-bordered full-color-table hover-table" id="produutsincart" border="1">
                                              <thead>
                                              <tr>
                                                <th class="hide">#</th>
                                                <th>Products</th>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="row">
                                        <div class="col-12"><a href="#" id="resetbtn" class="btn btn-danger pull-left">Cancel</a><a href="#" id="submitbtn" class="btn btn-success pull-right">Save and Next</a></div>
                                      </div>
        ...
        <script type="text/javascript" src="js/sale-purchase.js"></script>
    <!-- Style switcher -->
    <!-- ============================================================== -->
</body>
</html>
