<?php
  ...
  $meta['info']['title']='New Wholesale Bill';
                                          ...
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <div class="row el-element-overlay">
                                                ...
                                                <div class="col-lg-3 col-md-6 add_item_to_cart" id="item_<?=$row['id']?>_<?=$row['name']?>_<?=$row['wholesale_price']?>_<?=$row['available_stock']?>_<?=$row['purchase_cost']?>_<?=$row['measuring_unit']?>"  rel="<?=strtolower($row['name'])?>">
                                                  <div class="card">
                                                      <div class="el-card-item">
                                                          ...
                                                          <div class="el-card-content">
                                                              <h3 class="box-title"><?=$row['name']?></h3> <small><?=$_SESSION['sess_bp_currency']?> <?=$row['wholesale_price']?></small>
                                                              <br> </div>
                                                      </div>
                                                </div>
