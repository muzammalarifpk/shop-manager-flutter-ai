<?php
  ...
  $meta['info']['title']='Purchase History';
      ...
      if($(this).hasClass('show')){
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                    <h3>Customize Purchase History</h3>
                              ...
                              <div class="table-responsive m-t-40" id="no-more-tables">
                                ...
                                <tbody>
                                  ...
                                  if(isset($_GET['from_date']) && $_GET['from_date']!='')
                                  {
                                    ...
                                    $select_qry="select * from `purchase_invoices` where `owner_mobile`='$_SESSION[sess_bp_username]' $where $all_status_where order by `id` desc";
                                    foreach ($db->query($select_qry) as $row) {
                                   ?>
                                    <tr>
                                      <td data-title="ID: " class="bolder"><?=$row['id']?> <a  rel="<?=$row['id']?>" href="h-purchase-invoice.php?id=<?=$row['id']?>" class="btn btn-sm btn-warning view_invoice_btn">View Invoice</a></td>
                            ...
                            <br>
                            <p>
                              <a href="h-purchase.php?show_all_status=yes" class="btn btn-sm pull-right btn-info">Show Deleted</a>
                              <a href="h-purchase.php" class="btn btn-sm pull-right btn-inverse">Hide Deleted</a>
                            </p>
        ...
        <script type="text/javascript">
          $(document).on('click','.view_invoice_btn',function(e){
            ...
            view_invoice('purchase_invoices',inv_id);
